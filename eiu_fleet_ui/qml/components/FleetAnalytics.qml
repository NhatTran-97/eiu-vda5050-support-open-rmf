...
Rectangle {
    ...
    // Typography follows the panel width only; content taller than the panel scrolls.
    ...
    readonly property color batteryColor: !hasBatteryReading ? Theme.textDim
                                          : (battery < uiConfig.lowBatteryPercent ? Theme.err
                                             : (battery < uiConfig.mediumBatteryPercent ? Theme.warn : Theme.success))
    ...
    readonly property color displayTaskColor: Theme.taskColor(displayTaskState)
    // Count cancelled and failed tasks separately.
    readonly property var taskStats: [
        { "label": "Completed", "value": completedCount, "barColor": Theme.success },
        { "label": "Underway",  "value": underwayCount,  "barColor": Theme.cyan },
        { "label": "Queued",    "value": queuedCount,    "barColor": Theme.warn },
        { "label": "Cancelled", "value": cancelledCount, "barColor": Theme.textDim },
        { "label": "Failed",    "value": failedCount,    "barColor": Theme.err }
    ]
    ...
    onRobotsChanged: updateTaskProgress()
    ...
    Flickable {
        ...
        anchors.fill: parent
        contentWidth: width
        contentHeight: Math.max(height, rootColumn.implicitHeight)
        interactive: contentHeight > height
        boundsBehavior: Flickable.StopAtBounds
        clip: true
        ScrollBar.vertical: ScrollBar { policy: scroller.interactive ? ScrollBar.AsNeeded : ScrollBar.AlwaysOff }
                    ...
                    ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                ComboBox {
                                    ...
                                    indicator: Text {
                                        ...
                                        text: "▾"
                                        color: robotSelector.count > 1 ? Theme.cyan : Theme.textDim
                                    ...
                                    background: Rectangle {
                                        ...
                                        color: robotSelector.hovered || robotSelector.popup.visible
                                               ? Theme.surfaceRaised : Theme.surfaceAlt
                                        border.color: robotSelector.popup.visible ? Theme.cyanBright : Theme.border
                                        border.width: 1
                                    }
                                ...
                                Rectangle {
                                    ...
                                    radius: 8
                                    color: root.eStopActive ? Theme.err : "transparent"
                                    border.color: root.eStopActive ? Theme.err
                                                  : (root.offline ? Theme.err
                                                     : (root.primaryRobot ? Theme.cyan : Theme.border))
                                    border.width: 1
                                    Text {
                                        id: statusText
                                        anchors.centerIn: parent
                                        text: root.eStopActive ? "E-STOP" : (root.offline ? "OFFLINE" : root.robotStatus)
                                        color: root.eStopActive ? Theme.text
                                               : (root.offline ? Theme.err
                                                  : (root.primaryRobot ? Theme.cyan : Theme.textDim))
                                        font.family: fontMono
                        ...
                        RowLayout {
                            ...
                            GridLayout {
                                ...
                                Text { text: "POSITION X"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.hasPose ? root.posX.toFixed(2) + " m" : "—"; color: Theme.text; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text { text: "POSITION Y"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.hasPose ? root.posY.toFixed(2) + " m" : "—"; color: Theme.text; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text { text: "HEADING"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.hasPose ? root.headingDegrees(root.yaw).toFixed(0) + "°" : "—"; color: Theme.cyan; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text { text: "SPEED"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.hasTele ? root.speed.toFixed(2) + " m/s" : "—"; color: Theme.text; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text {
                                ...
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.hasTele ? root.distanceSinceLastNode.toFixed(2) + " m" : "—"; color: Theme.text; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text { text: "LEVEL"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text { Layout.fillWidth: true; elide: Text.ElideRight; text: root.primaryRobot ? root.primaryRobot.level : "—"; color: Theme.text; font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true }
                                Text { text: "MODE"; color: Theme.textDim; font.pixelSize: 10 * root.uiScale; font.bold: true }
                                Text {
                                ...
                                Text {
                                    ...
                                    color: root.eStopActive ? Theme.err : Theme.success
                                    font.family: fontMono; font.pixelSize: 13 * root.uiScale; font.bold: true
                                }
                            }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        text: root.displayTask
                                              ...
                                              : "No task assigned"
                                        color: root.displayTask ? Theme.text : Theme.textDim
                                        font.pixelSize: 14 * root.uiScale
                                        font.bold: true
                                        elide: Text.ElideRight
                                    }
                                    Text {
                                        ...
                                        color: root.displayTask ? root.displayTaskColor : Theme.textDim
                                        font.family: fontMono
                                        font.pixelSize: 13 * root.uiScale
                                        font.bold: true
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        color: root.displayTaskState !== "completed"
                                               && root.displayTask && root.displayTask.error
                                               ? Theme.err : root.displayTaskColor
                                        font.family: fontMono
