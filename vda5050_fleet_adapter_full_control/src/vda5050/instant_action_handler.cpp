...
nlohmann::json build_cancel_order(int header_id, const std::string &manufacturer, const std::string &serial, const std::string &blocking_type)
{
...
nlohmann::json build_state_request(int header_id, const std::string &manufacturer, const std::string &serial, const std::string &blocking_type)
{
    nlohmann::json actions = nlohmann::json::array();
...
nlohmann::json build_start_pause(int header_id, const std::string &manufacturer, const std::string &serial, const std::string &blocking_type)
{
    nlohmann::json actions = nlohmann::json::array();
...
nlohmann::json build_stop_pause(int header_id, const std::string &manufacturer, const std::string &serial, const std::string &blocking_type)
{
    nlohmann::json actions = nlohmann::json::array();
...
InstantActionRequest build_instant_action(
    int header_id, const std::string &manufacturer, const std::string &serial, const std::string &action_type, const nlohmann::json &parameters, const std::string &blocking_type)
{
