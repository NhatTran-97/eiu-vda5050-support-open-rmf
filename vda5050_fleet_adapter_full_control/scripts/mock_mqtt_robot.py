...
def main():
    ...
    p.add_argument("--interface", default="AMR")
    p.add_argument("--manufacturer", default="ROBOTIS")
    p.add_argument("--serial", default="0001")
    p.add_argument("--map", default="tb3_world")
    p.add_argument("--start-node", default="charger_1")
    p.add_argument("--x", type=float, default=5.37)
    p.add_argument("--y", type=float, default=-6.65)
